...
const Home = () => {
  ...
  const menus = [
    ...
    { title: "Inbox",link: "/", src: "Chat" },
    { title: "Accounts",link: "/", src: "User", gap: true },
    { title: "Schedule ", link: "/",src: "Calendar" },
    { title: "Search", link: "/",src: "Search" },
    { title: "Analytics",link: "/", src: "Chart" },
    { title: "Files ", link: "/", src: "Folder", gap: true },
    { title: "Setting",link: "/",  src: "Setting" },
  ];
  ...
  return (
    <section className="flex gap-6">
      <div
        className={`bg-blue-700 min-h-screen ${
          open ? "w-72" : "w-20"
      ...
      >
        ...
        <div className="mt-4 flex flex-col gap-4 relative">
          {menus?.map((menu, i) => (
            ...
            >
                         <img src={`../components/assets/${menu.src}.png`} />
      ...
      <div className=" text-center text-xl text-gray-900 font-semibold">
        <Dashboard/>
      </div>
    </section>
  );
